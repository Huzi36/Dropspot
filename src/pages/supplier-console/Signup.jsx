...
export default function SupplierSignup() {
    ...
    async function handleSubmit(e) {
        ...
        setError('')
        try {
            await signUp(form.email, form.password, form.fullName, '+91' + form.phone, 'supplier')
        ...
        <div className="min-h-screen bg-white flex" style={{ fontFamily: "'DM Sans', sans-serif" }}>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12">
                <div className="w-full max-w-md">
                    ...
                    <h2 className="text-3xl font-bold text-[#143D59] mb-1" style={{ fontFamily: "'Syne', sans-serif" }}>
                        Become a Supplier
                    </h2>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="col-span-2">
                                ...
                                <input name="businessName" type="text" required value={form.businessName} onChange={handleChange}
                                    className="w-full border border-gray-300 text-gray-900 rounded-lg px-4 py-3 outline-none focus:ring-2 focus:ring-[#143D59]"
                        ...
                        <button type="submit" disabled={loading}
                            className="w-full bg-[#F5B41A] hover:bg-[#e0a218] text-[#143D59] font-bold py-3 rounded-lg transition-all disabled:opacity-50 mt-2">
                    ...
                    <p className="text-gray-500 text-sm text-center mt-6">
                        ...
                        <Link to="/seller-console" className="text-[#143D59] font-semibold hover:underline">
                            Log in
                        </Link>
                    </p>
